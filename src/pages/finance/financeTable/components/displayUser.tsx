...
export default function Displayuser() {
  ...
  const transaction_redux = useSelector((state: RootState) =>
    state.transaction.find(
      (singleTran) => id !== undefined && singleTran.tran_id === parseInt(id)
    )
  );
  let transDetail: TransactionType[] = [];

  if (transaction_redux) {
    transDetail = [transaction_redux];
  }
    ...
    <div>
      <form className="user_form">
        ...
        <fieldset disabled>
          ...
          {transDetail.map((item: TransactionType) => {
            return (
              <div key={id}>
                <div className="row">
